...
function main_menu() {
  echo "🎙️ Wine Installer – Arch Version"
  echo "1) Wine"
  ...
  case $choice in
    ...
    3)
      sudo pacman -S base-devel git wine
      ...
      sudo make install
      ;;
    4) sudo pacman -S mono ;;
    5) sudo pacman -S dosbox ;;
    6) sudo pacman -S q4wine ;;
    7) sudo pacman -S playonlinux ;;
    8)
